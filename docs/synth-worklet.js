    ...
    this.port.onmessage = (event) => {
      ...
      switch (msg.type) {
        ...
        case 'drum':
          ...
          if (track === 0) this.synth.triggerKick();
          else if (track === 1) this.synth.triggerSnare();
          else if (track === 2) this.synth.triggerHat();
          else if (track === 3) this.synth.triggerHat(); // open hat placeholder
          else if (track === 4) this.synth.triggerSnare(); // clap placeholder
          else if (track === 5) this.synth.triggerHat(); // rimshot placeholder
          break;
      }
    };
  }
